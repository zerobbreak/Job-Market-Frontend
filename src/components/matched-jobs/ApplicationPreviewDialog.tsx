      ...
      show({
        ...
        description:
          err instanceof Error
            ? err.message
            : "Could not generate download URL. Please try again.",
        variant: "error",
      });
    }
  };
          ...
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center h-full p-8 text-center bg-gray-50">
              ...
              <p className="text-gray-600 max-w-md mb-6">
                {error || "Preview content is missing or invalid."}
              </p>
              {onRetry && (
              ...
              >
                <ScrollArea className="h-full">
                  <iframe
                    ...
                    srcDoc={
                      cvHtml ||
                      "<html><body><div style='padding:2rem;font-family:sans-serif;color:#111'>No preview content</div></body></html>"
                    }
                  />
                </ScrollArea>
              </TabsContent>
                ...
                <div className="border rounded-md bg-white h-[600px] w-full overflow-hidden relative">
                  {loading ? (
                    ...
                    <iframe
                      srcDoc={
                        coverLetterHtml ||
                        "<html><body><div style='padding:2rem;font-family:sans-serif;color:#666'>No cover letter generated</div></body></html>"
                      }

        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Link to="/app" className="text-sm font-medium text-blue-600">
                Sign in
              </Link>
              <Link
                to="/app"
        ...
        <section className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-gray-600 mb-6">
              Upload your CV, get a structured profile, see high-match roles,
              and apply with tailored CVs and cover letters in one click.
            </p>
            <ul className="space-y-3">
              <li className="flex items-start">
                <CheckCircle className="h-5 w-5 text-green-600 mr-2 mt-0.5" />{" "}
                AI-analyzed profile and match scoring
              </li>
              <li className="flex items-start">
                <CheckCircle className="h-5 w-5 text-green-600 mr-2 mt-0.5" />{" "}
            ...
            <div className="mt-8 flex gap-4">
              <Link
                ...
                onClick={() =>
                  track("cta_click", { cta: "start_free" }, "landing")
                }
              >
                Start Free
              </Link>
              <Link
                ...
                onClick={() =>
                  track("cta_click", { cta: "see_demo" }, "landing")
                }
              >
                See Demo
              </Link>
          ...
          <div className="bg-white border rounded-xl shadow-sm p-6">
            <div className="bg-linear-to-br from-blue-500 to-purple-600 w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-6">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white border rounded-xl p-6">
              <p className="text-gray-700">
                Matched me to roles I hadn’t considered and the tailored CVs got
                me interviews.
              </p>
            ...
            <div className="bg-white border rounded-xl p-6">
              <p className="text-gray-700">
                I applied to three high-match jobs and got quick callbacks.
              </p>
              <p className="mt-3 text-sm text-gray-500">Data Analyst</p>
            </div>
            <div className="bg-white border rounded-xl p-6">
              <p className="text-gray-700">
                The email digests keep me focused on the best opportunities.
              </p>
          ...
          <div className="bg-white border rounded-xl p-6 flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600">
                Start free and apply with AI-tailored documents.
              </p>
            </div>
            <Link
              to="/app"
